                                ...
                                @foreach ($images as $image)
                                    <div class="item-slick3" data-thumb="{{ asset('storage/' . $image) }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ asset('storage/' . $image) }}" alt="{{ $product->name }}" style="max-width: 100%; height: auto;">
                        
                                            <!-- Enlarge icon for viewing image in a lightbox -->
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="size-204 respon6-next">
                            ...
                            <!-- Sale Price in red -->
                            <span class="new-price" style="color: red; margin-left: 10px;">
